...
public class Employee implements Serializable {
    ...
    public void setImages(Set<Images> images) {
        if (this.images != null) {
            this.images.forEach(i -> i.setEmployee(null));
        }
        if (images != null) {
            images.forEach(i -> i.setEmployee(this));
        }
        this.images = images;
    }

    public Employee images(Set<Images> images) {
        this.setImages(images);
        return this;
    }

    public Employee addImages(Images images) {
        this.images.add(images);
        images.setEmployee(this);
        return this;
    }

    public Employee removeImages(Images images) {
        this.images.remove(images);
        images.setEmployee(null);
        return this;
    }
