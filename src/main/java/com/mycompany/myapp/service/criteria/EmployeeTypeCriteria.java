...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.EmployeeType} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.EmployeeTypeResource} to receive all the possible filtering options from
...
public class EmployeeTypeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, isActive, employeeId, distinct);
    }
