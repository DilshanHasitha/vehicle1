...
describe('CashBook Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'cash-book', component: CashBookComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cashBooks?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to cashBookService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCashBookIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCashBookIdentifier).toHaveBeenCalledWith(entity);
