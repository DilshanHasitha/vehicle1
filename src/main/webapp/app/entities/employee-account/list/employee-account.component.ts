...
import { EntityArrayResponseType, EmployeeAccountService } from '../service/employee-account.service';
...
export class EmployeeAccountComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEmployeeAccount): number => this.employeeAccountService.getEmployeeAccountIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.employeeAccounts = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IEmployeeAccount[] | null): IEmployeeAccount[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.employeeAccountService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
