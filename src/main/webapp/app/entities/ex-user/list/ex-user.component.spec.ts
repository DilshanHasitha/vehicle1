...
describe('ExUser Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ex-user', component: ExUserComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.exUsers?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to exUserService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExUserIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getExUserIdentifier).toHaveBeenCalledWith(entity);
