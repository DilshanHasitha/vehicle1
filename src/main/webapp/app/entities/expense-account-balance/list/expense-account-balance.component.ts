...
import { EntityArrayResponseType, ExpenseAccountBalanceService } from '../service/expense-account-balance.service';
...
export class ExpenseAccountBalanceComponent implements OnInit {
  ...
  trackId = (_index: number, item: IExpenseAccountBalance): number =>
    this.expenseAccountBalanceService.getExpenseAccountBalanceIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.expenseAccountBalances = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IExpenseAccountBalance[] | null): IExpenseAccountBalance[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.expenseAccountBalanceService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
