...
describe('ExpenseAccountBalance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'expense-account-balance', component: ExpenseAccountBalanceComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.expenseAccountBalances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to expenseAccountBalanceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getExpenseAccountBalanceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getExpenseAccountBalanceIdentifier).toHaveBeenCalledWith(entity);
