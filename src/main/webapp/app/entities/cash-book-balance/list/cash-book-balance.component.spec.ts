...
describe('CashBookBalance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'cash-book-balance', component: CashBookBalanceComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.cashBookBalances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to cashBookBalanceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCashBookBalanceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCashBookBalanceIdentifier).toHaveBeenCalledWith(entity);
