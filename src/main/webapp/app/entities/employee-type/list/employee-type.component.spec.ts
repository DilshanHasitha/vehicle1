...
describe('EmployeeType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'employee-type', component: EmployeeTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employeeTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to employeeTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmployeeTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmployeeTypeIdentifier).toHaveBeenCalledWith(entity);
