...
import { EntityArrayResponseType, EmployeeTypeService } from '../service/employee-type.service';
...
export class EmployeeTypeComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEmployeeType): number => this.employeeTypeService.getEmployeeTypeIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.employeeTypes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IEmployeeType[] | null): IEmployeeType[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.employeeTypeService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
