...
import { EntityArrayResponseType, EmployeeAccountBalanceService } from '../service/employee-account-balance.service';
...
export class EmployeeAccountBalanceComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEmployeeAccountBalance): number =>
    this.employeeAccountBalanceService.getEmployeeAccountBalanceIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.employeeAccountBalances = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IEmployeeAccountBalance[] | null): IEmployeeAccountBalance[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.employeeAccountBalanceService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
