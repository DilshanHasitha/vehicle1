...
describe('EmployeeAccountBalance Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'employee-account-balance', component: EmployeeAccountBalanceComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.employeeAccountBalances?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to employeeAccountBalanceService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmployeeAccountBalanceIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmployeeAccountBalanceIdentifier).toHaveBeenCalledWith(entity);
