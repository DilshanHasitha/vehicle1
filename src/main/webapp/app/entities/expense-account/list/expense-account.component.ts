...
import { EntityArrayResponseType, ExpenseAccountService } from '../service/expense-account.service';
...
export class ExpenseAccountComponent implements OnInit {
  ...
  trackId = (_index: number, item: IExpenseAccount): number => this.expenseAccountService.getExpenseAccountIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.expenseAccounts = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IExpenseAccount[] | null): IExpenseAccount[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.expenseAccountService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
